...
def calculate_similarity(kg1_triples, kg2_triples):
    ...
    print("======================================================")
    print(f"kg1_triples: {kg1_triples}, type: {type(kg1_triples)}")
    #print(f"kg2_triples: {kg2_triples}, type: {type(kg2_triples)}")
    ...
    print(f"\nFiltered evidence triples: {filtered_kg2_triples}\n")
    print("======================================================")
    ...
    #print("Relabelled KG1 Nodes:", relabelled_kg1.nodes(data=True))
    print("Relabelled KG1 Edges:", relabelled_kg1.edges(data=True))
    #print("Relabelled KG2 Nodes:", relabelled_kg2.nodes(data=True))
    print("Relabelled KG2 Edges:", relabelled_kg2.edges(data=True))
