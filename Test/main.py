...
if __name__ == "__main__":
    ...
    claim = "Rome is the capital city of France. France is a country in Asia. France has 900 million occupants. France shares a border with Germany."

    claims = ["Rome is the capital city of France", "France is a country in Asia", "France has 900 million occupants.", "France shares a border with Germany"]
    labels=["major_inaccurate", "major_inaccurate", "major_inaccurate", "accurate"]
    results = test(output, claims, labels, 0)
